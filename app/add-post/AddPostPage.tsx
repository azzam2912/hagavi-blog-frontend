                ...
                <form className="flex-row justify-center items-center w-4/5 py-4 space-y-4" onSubmit={handleSubmit}>
                    <div className="flex items-center justify-center">
                        ...
                        <input value={title}
                         ...
                         className="shadow-md focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-md border-gray-300 rounded-md text-black p-1" 
                         placeholder="Title" />
                    </div>
                    <div className="h-full flex items-center justify-center">
                        ...
                        className="shadow-md focus:ring-indigo-500 focus:border-indigo-500 block w-full min-h-[500px] sm:text-md border-gray-300 rounded-md text-black p-1" 
